...
import { normalizeHashRoute } from './lib/prototypeRoutes'
...
/** Fix encoded hash links (#%2Fdata-review) that otherwise miss every route. */
function HashRouteNormalizer() {
  const navigate = useNavigate()
  useEffect(() => {
    const decoded = normalizeHashRoute()
    if (decoded) navigate(decoded, { replace: true })
  }, [navigate])
  return null
}
